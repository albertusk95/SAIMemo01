...
<html lang="en">
    ...
    <head>
        ...
        <title>SAIMemo &middot; Forgot password</title>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>SAIMemo</strong> Forgot password GATE</h1>
                        ...
                        <div class="col-sm-6">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="<?php echo site_url('user_auth/forgot_pass'); ?>" method="post" class="forgot-pass-form">
				                    	<div class="form-group">
				                    		<label class="sr-only" for="fp-email">Email</label>
				                        	<input type="text" name="fp-email" value="<?php echo set_value('fp-email'); ?>" placeholder="Email..." class="fp-email form-control" id="fp-email">
											<font color="red"><?php echo form_error('fp-email'); ?></font> 
										</div>
