...
?>
<div class="container-fluid col-sm-6 col-sm-offset-3 navbar-offset">
	<div>
		<div class="file-icon">
	...
	<!-- Nav tabs -->
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane fade in active" id="tab-username">
				<?php echo form_open(site_url('user_auth/profile?edit=1'), array('id'=>'form-username')); ?>
			...
			<div role="tabpanel" class="tab-pane fade" id="tab-password">
				<?php echo form_open(site_url('user_auth/profile?edit=1'), array('id'=>'form-password')); ?>
				<input type="hidden" name="modify" value="password" />
				<div id="old-password-group" class="form-group">
