...
<div class="container-fluid navbar-offset">
	<ol class="breadcrumb">
		<li>
			<a href="<?= site_url('memo/folder') ?>" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-home"></span></a>
		</li>
		...
		<div class="pull-right">
			<?php echo form_open(site_url('memo/new_folder') . $path, array('class'=>'form-inline')); ?>
			...
			<a href="<?= site_url('memo/upload' . $path) ?>" class="btn btn-success btn-sm" rel="tooltip-left" title="Upload File"><span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span></a>
			</form>
