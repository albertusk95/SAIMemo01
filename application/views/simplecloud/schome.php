    ...
    <div class="intro-header">
		...
		<div class="col-xs-12 text-center abcen1">
			...
			<ul class="list-inline intro-social-buttons">
				<li><a href="<?php echo base_url('user_auth/signup'); ?>" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">Sign up</span></a>
				</li>
				<li id="download" ><a href="#downloadlink" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.2s"><span class="network-name">Log in</span></a>
				</li>
			</ul>
		</div>    
        <!-- /.container -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img class="rotate" src="../../assets/img/icon/file.svg" alt="Store your folders and files">
				  <h3>Folders & Files</h3>
				  <p class="lead">Store your folders and files which can be accessed in any time</p>
				</div>
				
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="../../assets/img/icon/gallery.svg" alt="Store your images">
				   <h3>Images</h3>
				   <p class="lead">Take wondeful images and keep them in a safe place</p>
				</div>
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="../../assets/img/icon/video.svg" alt="Store your videos">
				   <h3>Videos</h3>
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeftBig">
                     <div id="owl-demo-1" class="owl-carousel">
						<a href="../../assets/img/iphone.png" class="image-link">
							<div class="item">
								<img  class="img-responsive img-rounded" src="../../assets/img/iphone.png" alt="">
							</div>
						</a>
						<a href="../../assets/img/iphone.png" class="image-link">
							<div class="item">
    ...
    <div class="content-section-a">
        ...
        <div class="container">
             ...
             <div class="row">
				...
				<div class="col-sm-6 pull-right wow fadeInRightBig">
                    <img class="img-responsive " src="../../assets/img/doge.png" alt="">
                </div>
          ...
          <div class="row" >
		    ...
		    <div class="row wow bounceInUp" >
              <div id="owl-demo" class="owl-carousel">
				...
				<a href="../../assets/img/slide/1.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="../../assets/img/slide/1.png" alt="Owl Image">
					</div>
				</a>
				
               <a href="../../assets/img/slide/2.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="../../assets/img/slide/2.png" alt="Owl Image">
					</div>
				</a>
				
				<a href="../../assets/img/slide/3.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="../../assets/img/slide/3.png" alt="Owl Image">
					</div>
				</a>
